...
<main>
    <!-- Heading for the 'Write for us' section -->
    <h2>Write for us</h2>
    <!-- Section for writing content for the publication -->
    <section id="write-for-us">
        <?php

        require_once "route-controller.php";
        require_once "user-controller.php";
        global $routeController, $userController;


        if ($userController->isUserLoggedIn()) {
            $routeController->generateForm();

            if (filter_input(INPUT_POST, 'submit',
                FILTER_SANITIZE_FULL_SPECIAL_CHARS)) {
                $routeController->submitForm();
            }
        }
        ?>
...
<script src="js/write-for-us.js"></script>
